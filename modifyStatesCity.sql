...
INSERT INTO `tbl_cities` (`city_id`, `city_name`, `state_id`) VALUES
...
--
ALTER TABLE `tbl_cities`
MODIFY `city_id` int(4) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=604;
--

-- AUTO_INCREMENT for table `states`
--
ALTER TABLE `tbl_states`
MODIFY `state_id` int(2) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=36;
