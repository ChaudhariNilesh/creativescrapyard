    ...
    OffcanvasDropdown = (function() {
      function OffcanvasDropdown(element) {
        ...
        this.nav.closest('.navbar-offcanvas').on('click', (function(_this) {
          return function() {
            if (_this.dropdown.is('.show')) {
              return _this.dropdown.removeClass('show').closest('.open').removeClass('open');
            }
          };
        })(this));
      }
      ...
      OffcanvasDropdown.prototype._clickEvent = function(e) {
        ...
        e.stopPropagation();
        $('.dropdown-toggle').not(this.element).closest('.open').removeClass('open').find('.dropdown-menu').removeClass('show');
