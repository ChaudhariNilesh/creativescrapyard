...
class UserFilter(django_filters.FilterSet):
    ...
    is_active = django_filters.ChoiceFilter(field_name='is_active',choices=STATUS_CHOICES)
    is_verified = django_filters.ChoiceFilter(field_name='profile__is_verified',choices=VERIFIED_CHOICES)
    date_joined = django_filters.DateFromToRangeFilter(field_name='date_joined')

    class Meta:
        model = User
        fields = ['username','email','first_name','last_name','is_active','date_joined','is_verified']
